...
    <div style={{
        ...styles.container, 
        /* UPDATED: Changed light mode gradient to be darker/clearer to stop the white sheet effect over the image */
...
        backgroundColor: 'transparent' // Force container transparency
    }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;800&display=swap');
        
        /* HARD RESET for white backgrounds on root elements */
        html, body, #root { 
          margin: 0 !important; 
          padding: 0 !important; 
...
        
        .state-card:hover { transform: translateY(-5px); border: 2px solid ${theme.secondary} !important; box-shadow: 0 10px 20px rgba(0,104,55,0.15) !important; background: white !important; }
...
  stateCard: { padding: '30px 15px', borderRadius: '20px', border: '1px solid', textAlign: 'center', cursor: 'pointer', transition: '0.2s', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' },
